...
DSE_CQL_HTML_FALLBACK = 'https://docs.datastax.com/en/dse/6.7/cql/index.html'
...
class DSEShell(OriginalShell):
    def __init__(self, hostname, port, color=False,
        ...
        self.execution_profile = self.session._get_execution_profile(EXEC_PROFILE_DEFAULT)
